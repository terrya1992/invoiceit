/*
 * InvoiceIt — free invoice generator v1.1
...
(function () {
  ...
  var TEMPLATES = {
    ...
    freelance: {
      ...
      qtyPlaceholder: '5', ratePlaceholder: '350.00',
      lineTypes: false, cis: false, defaultVat: null
    },
    contractor: {
  ...
  var CSS = [
    ...
    '@media (max-width:767px){.gen-line{grid-template-columns:1fr 1fr auto}.gen-line [data-desc]{grid-column:1/-1}' + (TPL.lineTypes ? '.gen-line [data-type]{grid-column:1/-1}' : '') + '.gen-line-head{display:none}}',
  ...
  function render() {
    ...
    var terms = val('payment-terms')
      ? '<div class="iv-terms"><div class="iv-cap">Payment details</div><div class="iv-muted">' + esc(val('payment-terms')) + '</div></div>'
      : '';
